...
static inline void scsi_print_sense_hdr(const struct scsi_device *sdev,
		const char *name, const struct scsi_sense_hdr *sshdr)
{
}
static inline void scsi_print_sense(const struct scsi_cmnd *cmd)
{
}
static inline void __scsi_print_sense(const struct scsi_device *sdev,
		const char *name, const unsigned char *sense_buffer, int sense_len)
{
}
